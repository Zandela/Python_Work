...
def update_bullets(ai_settings, screen, stats, aliens, bullets, score_board):
	'''更新子弹的位置，并删除已消失的子弹'''
	# 更新子弹位置
	bullets.update()
	...
	# 检测碰撞并处理
	check_bullet_alien_collisions(ai_settings, screen, stats, aliens, bullets,
		score_board)

def check_bullet_alien_collisions(ai_settings, screen, stats, aliens, bullets,
	score_board):
	'''响应子弹和外星人的碰撞'''
	# 删除发生碰撞的子弹和外星人
